$(document).on("click", "#searchCity", function () {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q=London,us&appid=ea1ee909c94c46ccd1e4885c0e999ea2";
...
var storedHistory = localStorage.getItem('weather')
